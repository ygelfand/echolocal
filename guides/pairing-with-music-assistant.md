...
Each Dot keeps itself to Music Assistant's clock, correcting its own speaker's drift as it plays, so
two rooms should stay together for the length of a track. If one still sounds a touch ahead of or
behind another, open that player's settings in Music Assistant and adjust its delay. A positive delay makes the room play earlier. Changes apply straight away, and
